...
public class DominoGameState extends GameState {
    ...
    public boolean playableTrains(int id, Domino selectedDomino, int train) {
         ...
         */
        if ((player1Public == true && trainSelection == 0) || (id == 0 && trainSelection == 0)) {//checks if player 1's train is public
        ...
        } else if ((player2Public == true && trainSelection == 1) || (id == 1 && trainSelection == 1)) {//checks if player 1's train is public
            if (currentTrain.size() == 0 && (selectedDomino.rightSide == round
                    || selectedDomino.leftSide == round)) {
                returnCheck = true;//first domino of the round, played on round number
            } else if (currentTrain.size() == 0) {
        ...
        } else if ((player3Public == true && trainSelection == 2) || (id == 2 && trainSelection == 2)) {//checks if player 1's train is public
            if (currentTrain.size() == 0 && (selectedDomino.rightSide == round
                    || selectedDomino.leftSide == round)) {
                returnCheck = true;//first domino of the round, played on round number
            } else if (currentTrain.size() == 0) {
        ...
        } else if ((player4Public == true && trainSelection == 3) || (id == 3 && trainSelection == 3)) {//checks if player 1's train is public
            if (currentTrain.size() == 0 && (selectedDomino.rightSide == round
                    || selectedDomino.leftSide == round)) {
                returnCheck = true;//first domino of the round, played on round number
            } else if (currentTrain.size() == 0) {
