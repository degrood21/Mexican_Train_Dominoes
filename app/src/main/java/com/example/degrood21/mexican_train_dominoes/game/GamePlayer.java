...
/**
 * A player who plays a (generic) com.example.degrood21.mexican_train_dominoes.game. Each class that implements a player for
 * a particular com.example.degrood21.mexican_train_dominoes.game should implement this interface.
 * 
