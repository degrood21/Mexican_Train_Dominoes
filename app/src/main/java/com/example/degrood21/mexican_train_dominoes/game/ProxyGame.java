...
/**
 * A Game object that is used as a proxy for the real com.example.degrood21.mexican_train_dominoes.game that is on another
...
public class ProxyGame implements Game {
    ...
    // the player associated with this com.example.degrood21.mexican_train_dominoes.game
     ...
     * @param ipCode
     * 			the IP code of the server where the com.example.degrood21.mexican_train_dominoes.game is hosted
     * @return
     */
    public static ProxyGame create(int portNum, String ipCode) {
    	// create the com.example.degrood21.mexican_train_dominoes.game object
     ...
     *  	com.example.degrood21.mexican_train_dominoes.game is running
     */
	...
	/**
	 * Starts the com.example.degrood21.mexican_train_dominoes.game. In this context, we know that the array will
