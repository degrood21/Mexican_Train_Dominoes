...
/**
 * An action for a generic com.example.degrood21.mexican_train_dominoes.game.  A com.example.degrood21.mexican_train_dominoes.game action is something that a player
 * tells the com.example.degrood21.mexican_train_dominoes.game that it wants to do (e.g., put an 'X' on the top-left
 * tic-tac-toe square).  The com.example.degrood21.mexican_train_dominoes.game will then decide whether the player is
 ...
 * actions that are relevant to the particular com.example.degrood21.mexican_train_dominoes.game.  A GameAction contains
 * the player as part of its state; this way the com.example.degrood21.mexican_train_dominoes.game always knows what
