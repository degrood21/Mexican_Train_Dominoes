...
/**
 * An informational message that is sent from the com.example.degrood21.mexican_train_dominoes.game to a player.  The
 * most common information will probably be the state of the com.example.degrood21.mexican_train_dominoes.game (GameState),
...
public abstract class GameInfo implements Serializable {
	...
	/**
	 * Sets the com.example.degrood21.mexican_train_dominoes.game attribute (if applicable) of the GameInfo object.
	 * The intent is that this be method be called only by ProxyGame and
	 * ProxyPlayer.
	 * 
	 * @param g
	 * 		the com.example.degrood21.mexican_train_dominoes.game to which the objects 'com.example.degrood21.mexican_train_dominoes.game' attribute is to be set
	 */
	public void setGame(Game g) {
		// the default behavior is to do nothing, as it is expected that most
		// GameInfo objects do not contain com.example.degrood21.mexican_train_dominoes.game information.
	}
