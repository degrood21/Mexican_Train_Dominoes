package com.example.degrood21.mexican_train_dominoes.game.util;
...
public class GameTimer {
	// the com.example.degrood21.mexican_train_dominoes.game to send actions to
	...
	{
		this.target = target; // initialize com.example.degrood21.mexican_train_dominoes.game
	...
	/**
	 * The number of GameTimerActions sent to the com.example.degrood21.mexican_train_dominoes.game since the timer
